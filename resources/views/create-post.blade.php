...
@section("content")
    <div class="post-page-container editor-container">
        ...
        <form class="post-form" action="{{ route('store') }}" method="post">
            @csrf
            <input required maxlength="64" name="title" type="text" placeholder="Title"></input>
            <input required maxlength="64" name="author" type="text" placeholder="Author" value="Guest"></input>
